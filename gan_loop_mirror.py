...
BETA=2.5 #beta coefficient on diversity term
...
if __name__=='__main__':
    ...
    with strategy.scope():
        ...
        output_blocks=[BLOCK]
        autoenc=aegen(BLOCK,base_flat_noise_dim=base_flat_noise_dim,residual=RESIDUAL,attention=ATTENTION,output_blocks=output_blocks)
    ...
    def train_step(images,gen_training,disc_training,diversity_training):
        ...
        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            ...
            real_output,_ = disc(images, training=disc_training)
            fake_output,_ = disc(generated_images, training=disc_training)
